...
const AttendanceFormScreen = () => {
  ...
  const handleSaveAttendance = async () => {
    try {
      ...
      showLoader();
      await createAttendance({ classId: id || "", date, records: attendance, markedBy: markedBy || "unknown" });
              ...
              classData?.students?.map((student: string, idx: number) => (
                ...
                >
                  ...
                  <View className="flex-row justify-between">
                    <TouchableOpacity
                      className={`flex-1 mx-1 py-2 px-3 rounded-xl flex-row items-center justify-center ${attendance[student] === 'present'
                    ...
                    >
                      ...
                      <Text className={`text-xs font-semibold ${attendance[student] === 'present' ? 'text-emerald-700' : 'text-slate-600'
                        }`}>
                        Present
                      </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      className={`flex-1 mx-1 py-2 px-3 rounded-xl flex-row items-center justify-center ${attendance[student] === 'absent'
                    ...
                    >
                      ...
                      <Text className={`text-xs font-semibold ${attendance[student] === 'absent' ? 'text-red-700' : 'text-slate-600'
                        }`}>
                        Absent
                      </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      className={`flex-1 mx-1 py-2 px-3 rounded-xl flex-row items-center justify-center ${attendance[student] === 'late'
                    ...
                    >
                      ...
                      <Text className={`text-xs font-semibold ${attendance[student] === 'late' ? 'text-amber-700' : 'text-slate-600'
                        }`}>
                        Late
                      </Text>
                    </TouchableOpacity>
